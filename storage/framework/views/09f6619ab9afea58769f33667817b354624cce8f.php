                                ...
                                <div class="header-info">
                                    ...
                                    <div class="header-stats">
                                        ...
                                        <div class="stat-item-header">
                                            <span class="stat-number"><?php echo e($totalViagensUser); ?></span>
                                            <span class="stat-label">Total de Viagens</span>
                                        </div>
                                        <div class="stat-divider"></div>
                                        <div class="stat-item-header">
                                            <span class="stat-number"><?php echo e($viagensHoje); ?></span>
                                            <span class="stat-label">Hoje</span>
                                        </div>
                                        <div class="stat-divider"></div>
                                        <div class="stat-item-header">
                                            <span class="stat-number"><?php echo e(now()->format('d/m/Y')); ?></span>
                            ...
                            <div class="col-lg-4">
                                <div class="header-actions-professional">
                                    ...
                                    <div class="quick-actions">
                                        <button type="button" class="quick-btn" onclick="window.location.href='<?php echo e(route('viagens.create')); ?>'">
                                            <i class="bi bi-plus-lg"></i>
                                            <span>Nova Viagem</span>
                                        </button>
                                        <button type="button" class="quick-btn" onclick="window.location.href='<?php echo e(route('relatorios.index')); ?>'">
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content modern-modal">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h4 class="fw-bold mb-3 gradient-text">Olá, <?php echo e(Auth::user()->name); ?>!</h4>
                    ...
                    <div class="card-content-executive">
                        ...
                        <div class="card-body-executive">
                            ...
                            <div class="card-stats">
                                <div class="stat-mini">
                                    <span class="stat-number-mini"><?php echo e(\App\Models\Viagem::where('user_id', Auth::id())->whereDate('created_at', today())->count()); ?></span>
                                    <span class="stat-label-mini">Hoje</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer-executive">
                            <a href="<?php echo e(route('viagens.create')); ?>" class="btn-executive btn-success-exec">
                ...
                <div class="card-background">
                    ...
                    <div class="card-content-executive">
                        ...
                        <div class="card-body-executive">
                            ...
                            <div class="card-stats">
                                <div class="stat-mini">
                                    <span class="stat-number-mini"><?php echo e(\App\Models\Viagem::where('user_id', Auth::id())->count()); ?></span>
                                    <span class="stat-label-mini">Total</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer-executive">
                            <a href="<?php echo e(route('viagens.index')); ?>" class="btn-executive btn-primary-exec">
                ...
                <div class="card-background">
                    ...
                    <div class="card-content-executive">
                        ...
                        <div class="card-body-executive">
                            ...
                            <div class="card-stats">
                                <div class="stat-mini">
                                    <span class="stat-number-mini"><?php echo e(Auth::user()->created_at->diffInDays()); ?></span>
                                    <span class="stat-label-mini">Dias</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer-executive">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="btn-executive btn-info-exec">
                ...
                <div class="card-background">
                    ...
                    <div class="card-content-executive">
                        ...
                        <div class="card-body-executive">
                            ...
                            <div class="card-stats">
                                <div class="stat-mini">
                                    <span class="stat-number-mini"><?php echo e(\App\Models\Viagem::where('user_id', Auth::id())->whereMonth('created_at', now()->month)->count()); ?></span>
                                    <span class="stat-label-mini">Mês</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer-executive">
                            <a href="<?php echo e(route('relatorios.index')); ?>" class="btn-executive btn-warning-exec">
                                <i class="bi bi-file-earmark-bar-graph"></i>
                ...
                <div class="card-background">
                    ...
                    <div class="card-content-executive">
                        ...
                        <div class="card-body-executive">
                            ...
                            <div class="card-stats">
                                <div class="stat-mini">
                                    <span class="stat-number-mini"><?php echo e(Auth::user()->is_admin ? 'Admin' : 'User'); ?></span>
                                    <span class="stat-label-mini">Nível</span>
                                </div>
                            </div>
                        </div>
                        <div class="card-footer-executive">
                            <a href="<?php echo e(route('profile.edit')); ?>" class="btn-executive btn-secondary-exec">
                ...
                <div class="card-body">
                    ...
                    <div class="row g-3 mb-4">
                        <div class="col-6 col-md-3">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($kmDia); ?></div>
                                <div class="stat-label">KM Hoje</div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($kmMes); ?></div>
                                <div class="stat-label">KM no Mês</div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($totalViagens); ?></div>
                                <div class="stat-label">Total Viagens</div>
                            </div>
                        </div>
                        <div class="col-6 col-md-3">
                            <div class="stat-item">
                                <div class="stat-value"><?php echo e($viagensMes->count()); ?></div>
                    ...
                    <div class="last-trip-info">
                        ...
                        <div class="trip-details">
                            <div class="row g-2">
                                <div class="col-md-6">
                                    <strong>Data:</strong> <?php echo e($ultimaViagem->data instanceof \Carbon\Carbon ? $ultimaViagem->data->format('d/m/Y') : $ultimaViagem->data); ?>

                                </div>
                                <div class="col-md-6">
                                    <strong>Destino:</strong> <?php echo e($ultimaViagem->destino); ?>

                                </div>
                                <div class="col-md-6">
                                    <strong>KM Saída:</strong> <?php echo e($ultimaViagem->km_saida); ?>

                                </div>
                                <div class="col-md-6">
                                    <strong>KM Chegada:</strong> <?php echo e($ultimaViagem->km_chegada); ?>

                                </div>
                            </div>
                            <div class="mt-3">
                                <a href="<?php echo e(route('viagens.edit', $ultimaViagem->id)); ?>" class="btn btn-warning btn-sm modern-btn">
                    ...
                    <div class="empty-state">
                        ...
                        <a href="<?php echo e(route('viagens.create')); ?>" class="btn btn-primary modern-btn">
                    ...
                    <div class="mt-4">
                        <a href="<?php echo e(route('viagens.index')); ?>" class="btn btn-outline-primary modern-btn">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\elber\OneDrive\Documentos\GitHub\DIARIO-DE-BORDO\resources\views/dashboard.blade.php ENDPATH**/ ?>