...
<div class="container py-4">
    ...
    <div class="card shadow border-0 rounded-4 mb-3" style="background: #f8fafd;">
        <div class="card-body">
            <form class="row g-3 mb-3" method="GET" action="<?php echo e(route('relatorios.index')); ?>">
                <div class="col-md-4">
                    <label for="usuario" class="form-label">Condutor</label>
                    <select name="usuario" id="usuario" class="form-select" <?php echo e(!(auth()->check() && auth()->user()->isAdmin()) ? 'disabled' : ''); ?>>
                        <option value="">Todos</option>
                        <?php $__currentLoopData = $usuarios; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $usuario): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($usuario->name); ?>" <?php echo e(request('usuario', auth()->user()->name) == $usuario->name ? 'selected' : ''); ?>><?php echo e($usuario->name); ?></option>
                ...
                <div class="col-md-2">
                    ...
                    <select name="tipo_veiculo" id="tipo_veiculo" class="form-select">
                        <option value="">Todos</option>
                        <?php $__currentLoopData = $tipos_veiculo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tipo): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($tipo); ?>" <?php echo e(request('tipo_veiculo') == $tipo ? 'selected' : ''); ?>><?php echo e($tipo); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
                <div class="col-md-2">
                    ...
                    <select name="placa" id="placa" class="form-select">
                        ...
                        <?php $__currentLoopData = $placas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $placa): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($placa); ?>" <?php echo e(request('placa') == $placa ? 'selected' : ''); ?>><?php echo e($placa); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </div>
            ...
            <?php if(request('usuario') || request('data_inicio') || request('data_fim')): ?>
                <div class="d-flex gap-2 mb-3 flex-wrap">
                    ...
                    <a href="<?php echo e(route('relatorios.viagens.excel', request()->all())); ?>" class="btn btn-success d-flex align-items-center gap-2 fw-bold shadow-sm" style="background:linear-gradient(90deg,#43e97b 0%,#38f9d7 100%);border:none;">
            ...
            <?php if(isset($viagens) && count($viagens)): ?>
                    ...
                    <table class="table table-bordered align-middle text-center shadow-sm rounded-3 overflow-hidden" style="background:#fff;">
                        ...
                        <tbody>
                            ...
                            <tr style="background:<?php echo e($loop->even ? '#f8fafd' : '#fff'); ?>;">
                                <td><span class="badge bg-primary bg-opacity-75"><?php echo e($viagem->id); ?></span></td>
                                <td class="fw-semibold"><?php echo e($viagem->destino); ?></td>
                                <td><i class="bi bi-calendar2-week me-1 text-secondary"></i> <?php echo e(\Carbon\Carbon::parse($viagem->data)->format('d/m/Y')); ?></td>
                                <td><i class="bi bi-person-circle me-1 text-info"></i> <?php echo e($viagem->user->name ?? '-'); ?></td>
                                <td><span class="badge bg-secondary bg-opacity-50"><?php echo e($viagem->km_saida ?? '-'); ?></span></td>
                                <td><span class="badge bg-success bg-opacity-50"><?php echo e($viagem->km_chegada ?? '-'); ?></span></td>
                            </tr>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        </tbody>
                    </table>
                </div>
            <?php elseif(request()->all()): ?>
...
function exportPdf(action) {
    ...
    let url = `<?php echo e(route('relatorios.viagens.pdf')); ?>?${params.toString()}`;
    if(action === 'print') {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Elber\Documents\GitHub\prototipoSite\diario-bordo\resources\views/relatorios/index.blade.php ENDPATH**/ ?>