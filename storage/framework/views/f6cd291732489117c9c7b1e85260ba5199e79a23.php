        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                ...
                <div class="modal-body text-center py-4">
                    ...
                    <h4 class="fw-bold text-primary mb-3">Olá, <?php echo e(Auth::user()->name); ?>!</h4>
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center shadow border-0" style="background: linear-gradient(135deg, #b6cee8 0%, #f578dc 100%); color: #333;">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('viagens.create')); ?>" class="btn btn-outline-primary w-100 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Cadastrar nova viagem">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center shadow border-0" style="background: linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%); color: #333;">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('viagens.index')); ?>" class="btn btn-outline-success w-100 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Ver minhas viagens">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center shadow border-0" style="background: linear-gradient(135deg, #f5f7fa 0%, #c3cfe2 100%); color: #333;">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-info w-100 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Editar perfil">
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center shadow border-0" style="background: linear-gradient(135deg, #fdfbfb 0%, #ebedee 100%); color: #333;">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('relatorios.index')); ?>" class="btn btn-outline-primary w-100 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Acessar relatórios">
                    ...
                    <div class="modal fade" id="contatoModal" tabindex="-1" aria-labelledby="contatoModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <form action="<?php echo e(route('sugestoes.store')); ?>" method="POST">
                            <?php echo csrf_field(); ?>
        ...
        <div class="col-12 col-sm-6 col-md-4">
            <div class="card h-100 text-center shadow border-0" style="background: linear-gradient(135deg, #e0c3fc 0%, #8ec5fc 100%); color: #333;">
                <div class="card-body">
                    ...
                    <a href="<?php echo e(route('profile.edit')); ?>" class="btn btn-outline-secondary w-100 fw-bold shadow-sm d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Editar perfil e preferências">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group mb-3 text-start">
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between align-items-md-center bg-transparent border-0 text-dark">
                            <span><strong><i class="bi bi-speedometer2 me-2"></i>KMs rodados hoje (<?php echo e($hoje->format('d/m/Y')); ?>):</strong></span>
                            <span class="badge rounded-pill px-3 py-2 bg-primary bg-opacity-25 text-primary" style="font-size:1rem;"><i class="bi bi-lightning-charge-fill me-1"></i> <?php echo e($kmDia); ?></span>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between align-items-md-center bg-transparent border-0 text-dark">
                            <span><strong><i class="bi bi-calendar2-week-fill me-2"></i>KMs rodados no mês (<?php echo e($inicioMes->format('m/Y')); ?>):</strong></span>
                            <span class="badge rounded-pill px-3 py-2 bg-success bg-opacity-25 text-success" style="font-size:1rem;"><i class="bi bi-calendar2-check-fill me-1"></i> <?php echo e($kmMes); ?></span>
                        </li>
                        <li class="list-group-item d-flex flex-column flex-md-row justify-content-between align-items-md-center bg-transparent border-0 text-dark">
                            <span><i class="bi bi-collection me-2"></i>Total de viagens cadastradas:</span>
                            <span class="badge rounded-pill px-3 py-2 bg-warning bg-opacity-25 text-warning" style="font-size:1rem;"><i class="bi bi-flag-fill me-1"></i> <?php echo e($totalViagens); ?></span>
                        </li>
                        <li class="list-group-item bg-transparent border-0 text-dark">
                            ...
                            <?php if($ultimaViagem): ?>
                                Data: <?php echo e($ultimaViagem->data instanceof \Carbon\Carbon ? $ultimaViagem->data->format('d/m/Y') : $ultimaViagem->data); ?><br>
                                Destino: <?php echo e($ultimaViagem->destino); ?><br>
                                KM Saída: <?php echo e($ultimaViagem->km_saida); ?><br>
                                KM Chegada: <?php echo e($ultimaViagem->km_chegada); ?>

                                <a href="<?php echo e(route('viagens.edit', $ultimaViagem->id)); ?>" class="btn btn-outline-warning btn-sm ms-2 mt-2 mt-md-0 w-100 w-md-auto d-inline-flex align-items-center gap-2" tabindex="0" aria-label="Editar última viagem">
                    ...
                    <a href="<?php echo e(route('viagens.index')); ?>" class="btn btn-outline-secondary w-100 fw-bold d-flex align-items-center justify-content-center gap-2" tabindex="0" aria-label="Ver detalhes das viagens">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\Elber\Documents\GitHub\prototipoSite\diario-bordo\resources\views/dashboard.blade.php ENDPATH**/ ?>